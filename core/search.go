...
func (q *EntryQueries) SearchEntries(ctx context.Context, query string, limit int) ([]*Entry, error) {
	return q.store.SearchEntries(ctx, query, limit)
}

// SearchEntriesPage returns paginated full-text search results plus metadata.
func (q *EntryQueries) SearchEntriesPage(ctx context.Context, query string, limit, offset int) (*EntryPage, error) {
