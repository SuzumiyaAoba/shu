...
- [x] `Fetcher` independently instantiable and testable
- [x] Each domain type depends on minimum necessary Store sub-interfaces
- [x] `Service` methods are single-line delegations only
- [x] All existing tests pass
- [x] `cmd` layer requires no changes (Facade maintains API)
